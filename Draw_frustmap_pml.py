...
def main():
    #if len(sys.argv) != 6:
    print "*py txtfile pmlfile #residue"
    print "green: minimally frustrated interaction; red: highly frustrated interaction"
    #   sys.exit()
    pmlfile1 = sys.argv[1]
    n_res = int(sys.argv[2])
    #xname = sys.argv[3]
    #yname = sys.argv[4]
    #title = sys.argv[5]
    ...
    #matrix = merge_matrix(contactmap1,contactmap2,len(contactmap1)) 
    draw_contactmap(frustmap1)
